      ...
      <View style={styles.optionsRow}>
        {['rapid_acting', 'long_acting', 'mixed'].map(t => (
          <TouchableOpacity
            ...
            style={[styles.smallTag, { backgroundColor: insulinType === t ? C.red : colors.backgroundMuted }]}
          >
            <Text style={[styles.tagText, insulinType === t ? { color: colors.textOnPrimary } : { color: C.text }]}>
              {t.replace('_', ' ')}
            </Text>
          </TouchableOpacity>
        ))}
      ...
      <View style={styles.optionsRow}>
        {['abdomen', 'thigh', 'arm'].map(s => (
          <TouchableOpacity
            key={s}
            onPress={() => setSite(s)}
            style={[styles.smallTag, { backgroundColor: site === s ? C.red : colors.backgroundMuted }]}
          >
            <Text style={[styles.tagText, site === s ? { color: colors.textOnPrimary } : { color: C.text }]}>{s}</Text>
          </TouchableOpacity>
        ))}
      </View>
    </View>
      ...
      <View style={styles.optionsRow}>
        {[
          ...
          <TouchableOpacity
            ...
            style={[styles.smallTag, { backgroundColor: activityType === t ? C.red : colors.backgroundMuted }]}
          >
            <Text style={[styles.tagText, activityType === t ? { color: colors.textOnPrimary } : { color: C.text }]}>{t}</Text>
          </TouchableOpacity>
        ))}
      </View>
      ...
      <View style={styles.optionsRow}>
        {['low', 'moderate', 'high'].map(i => (
          <TouchableOpacity
            ...
            style={[styles.smallTag, { backgroundColor: intensity === i ? C.red : colors.backgroundMuted }]}
          >
            <Text style={[styles.tagText, intensity === i ? { color: colors.textOnPrimary } : { color: C.text }]}>{i}</Text>
          </TouchableOpacity>
        ))}
      </View>
    </View>
        ...
        >
          ...
          <ScrollView style={styles.scroll} showsVerticalScrollIndicator={false}>
            ...
            <TouchableOpacity 
              ...
              onPress={handleSave}
            >
              <Text style={[styles.saveBtnText, { color: colors.textOnPrimary }]}>Save Entry</Text>
            </TouchableOpacity>
