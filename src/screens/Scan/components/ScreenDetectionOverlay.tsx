  ...
  return (
    <GestureHandlerRootView style={styles.container}>
              ...
              <GestureDetector gesture={dragGesture}>
                  <Animated.View style={[styles.rectangle, animatedStyle]}>
                      <GestureDetector gesture={createCornerGesture('tl')}>
                        <Animated.View style={[styles.cornerHandle, { top: -15, left: -15, shadowColor: colors.shadow }]} />
                      </GestureDetector>
                      <GestureDetector gesture={createCornerGesture('tr')}>
                        <Animated.View style={[styles.cornerHandle, { top: -15, right: -15, shadowColor: colors.shadow }]} />
                      </GestureDetector>
                      <GestureDetector gesture={createCornerGesture('bl')}>
                        <Animated.View style={[styles.cornerHandle, { bottom: -15, left: -15, shadowColor: colors.shadow }]} />
                      </GestureDetector>
                      <GestureDetector gesture={createCornerGesture('br')}>
                        <Animated.View style={[styles.cornerHandle, { bottom: -15, right: -15, shadowColor: colors.shadow }]} />
                      </GestureDetector>
      ...
      <View style={styles.controls}>
        <TouchableOpacity style={[styles.buttonCancel, { backgroundColor: colors.criticalText }]} onPress={onCancel}>
          <X color={colors.textOnPrimary} size={24} />
        </TouchableOpacity>

        <TouchableOpacity style={[styles.buttonRetake, { backgroundColor: colors.orange }]} onPress={onRetake}>
          <RotateCcw color={colors.textOnPrimary} size={20} />
          <Text style={styles.buttonText}>Retake</Text>
        </TouchableOpacity>

        <TouchableOpacity style={[styles.buttonConfirm, { backgroundColor: colors.success }]} onPress={handleConfirm}>
...
const styles = StyleSheet.create({
  ...
  buttonConfirm: { flexDirection: 'row', paddingHorizontal: 25, paddingVertical: 15, borderRadius: 30, alignItems: 'center', elevation: 4 },
  buttonRetake: { flexDirection: 'row', paddingHorizontal: 25, paddingVertical: 15, borderRadius: 30, alignItems: 'center', elevation: 4 },
  buttonCancel: { padding: 15, borderRadius: 35, elevation: 4 },
